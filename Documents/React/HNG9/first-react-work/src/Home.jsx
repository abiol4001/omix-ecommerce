...
import profilep from "/src/profile-pic.jpg";

import btnLinks from "/public/GetInfo";
...
export const Home = () => {
  return (
    <div className="w-[90%] md:w-[70%] mx-auto h-full flex flex-col justify-center items-center py-5">
      <div className="text-center mb-7">
        ...
        />
        <h2 className="font-bold mt-4" id="twitter">
          Cave Man Dev
        </h2>
      ...
      <div className="w-[100%] mt-4">
        <ul className="list-none text-slate-800 text-center">
          {btnLinks.map((btnlink, index) => (
            <li
              key={btnlink.id}
              className="w-[100%] py-3 text-black bg-[#EAECF0] rounded-md mb-3 cursor-pointer"
            >
              <a
                href={btnlink.link}
                id={btnlink.id}
