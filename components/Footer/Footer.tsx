...
const Footer = () => {
    return (
        <>
            <hr className='mt-20 text-[#B6B6B6]' />
            <FooterForm />
            <footer className='bg-[#212429] py-[88px] px-[112px] text-[#FFFFFF]'>
                ...
                <div className='md:flex mt-[50px] font-[300]'>
                    ...
                    <div className='lg:w-1/4 justify-self-end'>
                    ...
                    <div className='lg:w-1/4 justify-self-end'>
                        ...
                        <ul className='text-white flex items-center gap-5 text-[25px] '>
                            <li>
                                <Link href="#"><SlSocialYoutube size={20} /></Link>
                            </li>
                            <li>
                ...
                <div className='md:flex justify-between gap-10 py-[90px] font-[300] text-[12px] text-[#737373]'>
